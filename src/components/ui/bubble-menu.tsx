/** biome-ignore-all lint/complexity/useLiteralKeys: react bits menu */
'use client';
      ...
      bubbles.forEach((bubble, i) => {
        ...
        if (labels[i]) {
          tl.to(
            ...
            // biome-ignore lint/style/useTemplate: duration sync
      ...
      {showOverlay && (
        ...
        >
          <ul
            ...
            // biome-ignore lint/a11y/noNoninteractiveElementToInteractiveRole: native menu
            role="menu"
